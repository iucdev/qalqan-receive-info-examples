...
namespace Qalqan.ReceiveInfo.Examples.DayHospital_LoadOrUpdateCases
{
    // =====================================================================================
    ...
    public class IntegraRequest
    {
        ...
        public string RequestType { get; set; } = "DayHospital_LoadOrUpdateCases";

        public LoadDayHospitalCasesRequest? DayHospital_LoadOrUpdateRequest { get; set; }
    ...
    public LoadDayHospitalCasesResponse? DayHospital_LoadOrUpdateResponse { get; set; }

    /// <summary>Блок результата (есть только при StatusCode = 200).</summary>
    public LoadDayHospitalCasesResponse? Result => DayHospital_LoadOrUpdateResponse;
    ...
    public static class Example
    {
        ...
        {
            DayHospital_LoadOrUpdateRequest = new LoadDayHospitalCasesRequest
            {
                List =
                {
