...
namespace Qalqan.ReceiveInfo.Examples.Reception_LoadCases
{
    // =====================================================================================
    ...
    public class IntegraRequest
    {
        ...
        public string RequestType { get; set; } = "Reception_LoadCases";

        public LoadReceptionRoomCasesRequest? Reception_LoadCasesRequest { get; set; }
    ...
    public LoadReceptionRoomCasesResponse? Reception_LoadCasesResponse { get; set; }

    /// <summary>Блок результата (есть только при StatusCode = 200).</summary>
    public LoadReceptionRoomCasesResponse? Result => Reception_LoadCasesResponse;
    ...
    public static class Example
    {
        ...
        {
            Reception_LoadCasesRequest = new LoadReceptionRoomCasesRequest
            {
                List =
                {
                    new ReceptionRoomCaseRequest
                    {
                        ...
                        Services =
                        {
                            new ReceptionRoomServiceItemRequest { ServiceCode = "B01.047.011", Quantity = 1, Date = new DateTime(2026, 4, 10) },
