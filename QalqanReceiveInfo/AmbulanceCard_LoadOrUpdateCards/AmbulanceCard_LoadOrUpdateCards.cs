...
namespace Qalqan.ReceiveInfo.Examples.AmbulanceCard_LoadOrUpdateCards
{
    // =====================================================================================
    ...
    public class IntegraRequest
    {
        ...
        public string RequestType { get; set; } = "AmbulanceCard_LoadOrUpdateCards";

        public LoadAmbulanceCardsRequest? AmbulanceCard_LoadOrUpdateCardsRequest { get; set; }
    ...
    public LoadAmbulanceCardsResponse? AmbulanceCard_LoadOrUpdateCardsResponse { get; set; }

    /// <summary>Блок результата (есть только при StatusCode = 200).</summary>
    public LoadAmbulanceCardsResponse? Result => AmbulanceCard_LoadOrUpdateCardsResponse;
    ...
    public static class Example
    {
        ...
        {
            AmbulanceCard_LoadOrUpdateCardsRequest = new LoadAmbulanceCardsRequest
            {
                List =
                {
