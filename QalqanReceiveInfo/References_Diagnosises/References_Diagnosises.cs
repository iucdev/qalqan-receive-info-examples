...
namespace Qalqan.ReceiveInfo.Examples.References_Diagnosises
{
    // =====================================================================================
    ...
    public class IntegraRequest
    {
        ...
        public string RequestType { get; set; } = "References_Diagnosises";

        public ReferencesRequest? References_DiagnosisesRequest { get; set; }
    ...
    public class ReferencesDiagnosisesResponse : ReferencePageBase
    {
        [XmlArray("Items")]
        [XmlArrayItem("DiagnosisesReferenceItem")]
        public List<DiagnosisesReferenceItem> Items { get; set; } = new List<DiagnosisesReferenceItem>();
    }
    ...
    /// <summary>Элемент справочника диагнозов МКБ-10.</summary>
    public class DiagnosisesReferenceItem
    {
    ...
    public ReferencesDiagnosisesResponse? References_DiagnosisesResponse { get; set; }

    /// <summary>Блок результата (есть только при StatusCode = 200).</summary>
    public ReferencesDiagnosisesResponse? Result => References_DiagnosisesResponse;
    ...
    public static class Example
    {
        ...
        {
            References_DiagnosisesRequest = new ReferencesRequest { PageSize = 5, PageIndex = 1 }   // PageIndex с 0
        };
