// QalqanReceiveInfo / References_Services — постраничное получение справочника.
...
namespace Qalqan.ReceiveInfo.Examples.References_Services
{
    // =====================================================================================
    // ЗАПРОС: <data xsi:type="q1:IntegraRequest"> с RequestType = References_Services
    // =====================================================================================
    ...
    public class IntegraRequest
    {
        ...
        public string RequestType { get; set; } = "References_Services";

        public ReferencesRequest? References_ServicesRequest { get; set; }
    ...
    public class ReferencesServicesResponse : ReferencePageBase
    {
        [XmlArray("Items")]
        [XmlArrayItem("ServicesReferenceItem")]
        public List<ServicesReferenceItem> Items { get; set; } = new List<ServicesReferenceItem>();
    }

    /// <summary>Элемент справочника услуг (тарификатор).</summary>
    public class ServicesReferenceItem
    {
    ...
    public ReferencesServicesResponse? References_ServicesResponse { get; set; }

    /// <summary>Блок результата (есть только при StatusCode = 200).</summary>
    public ReferencesServicesResponse? Result => References_ServicesResponse;
    ...
    public static class Example
    {
        ...
        {
            References_ServicesRequest = new ReferencesRequest { PageSize = 5, PageIndex = 1 }   // PageIndex с 0
        };
  ...
  <ResponseInfo>
    <RequestType>References_Services</RequestType>
    <StatusCode>200</StatusCode>
    <Message>OK</Message>
  </ResponseInfo>
  <References_ServicesResponse>
    <Items>
      <ServicesReferenceItem>
        <Code>B01.047.001</Code>
        <NameRu>Прием (осмотр, консультация) врача общей практики первичный</NameRu>
        <NameKz>Жалпы практика дәрігерінің бастапқы қабылдауы</NameKz>
      </ServicesReferenceItem>
      <ServicesReferenceItem>
        <Code>B01.047.011</Code>
        <NameRu>Прием (осмотр, консультация) врача общей практики повторный</NameRu>
        <NameKz>Жалпы практика дәрігерінің қайталама қабылдауы</NameKz>
      </ServicesReferenceItem>
    </Items>
    <PageSize>5</PageSize>
    <PageIndex>1</PageIndex>
    <PagesCount>1290</PagesCount>
  </References_ServicesResponse>
</data>";
