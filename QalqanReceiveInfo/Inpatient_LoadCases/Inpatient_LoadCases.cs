...
namespace Qalqan.ReceiveInfo.Examples.Inpatient_LoadCases
{
    // =====================================================================================
    ...
    public class IntegraRequest
    {
        ...
        public string RequestType { get; set; } = "Inpatient_LoadCases";

        public LoadInpatientCasesRequest? Inpatient_LoadCasesRequest { get; set; }
    ...
    public LoadInpatientCasesResponse? Inpatient_LoadCasesResponse { get; set; }

    /// <summary>Блок результата (есть только при StatusCode = 200).</summary>
    public LoadInpatientCasesResponse? Result => Inpatient_LoadCasesResponse;
    ...
    public static class Example
    {
        ...
        {
            Inpatient_LoadCasesRequest = new LoadInpatientCasesRequest
            {
                List =
                {
