...
namespace Qalqan.ReceiveInfo.Examples.Services_LoadOrUpdateServices
{
    // =====================================================================================
    ...
    public class IntegraRequest
    {
        ...
        public string RequestType { get; set; } = "Services_LoadOrUpdateServices";

        public LoadServicesRequest? Services_LoadOrUpdateServicesRequest { get; set; }
    ...
    public LoadServicesResponse? Services_LoadOrUpdateServicesResponse { get; set; }

    /// <summary>Блок результата (есть только при StatusCode = 200).</summary>
    public LoadServicesResponse? Result => Services_LoadOrUpdateServicesResponse;
    ...
    public static class Example
    {
        ...
        {
            Services_LoadOrUpdateServicesRequest = new LoadServicesRequest
            {
                List =
                {
